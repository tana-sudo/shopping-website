...
<body>
    <header>
        <image src="icons/logo.jpg" class="logo"/>
        <nav>
            <ul>
                <li><a href="shoes.jsp" class="category">Shoes & Accessories</a></li>
                <li><a href="jewelry.jsp" class="category">Jewelry, Eye-wear, Watches & Accessories</a></li>
                ...
                <li><button type="button" class="currency" onclick="convertCurrency()">usd-pula</button></li>
    ...
    <section>
        ...
        <%
            ...
            try {
                ...
                String sql2 = "SELECT * FROM products ORDER BY price ASC"; 
        ...
        <%
            ...
            try {
                ...
                String sql3 = "SELECT * FROM products ORDER BY price DESC "; 
