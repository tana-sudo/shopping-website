        ...
        <nav>
            <ul>
               ...
               <li> <a href="cart.jsp" class="cart"><img src="icons/basket.png" class="cart-image"/> 
                <span class="cart-count"> <!-- Add a span tag for cart count -->
    <% 
    ...
    <section>
        <%
            ...
            try {
                ...
                String sql = "SELECT * FROM products where category='accessories'"; 
        ...
        <%
            ...
            try {
                ...
                String sql2 = "SELECT * FROM products where category='accessories' ORDER BY price ASC"; 
        ...
        <%
            ...
            try {
                ...
                String sql3 = "SELECT * FROM products where category='accessories' ORDER BY price DESC "; 
