        ...
        fetch('https://api.exchangerate-api.com/v4/latest/USD')
            ...
            .then(data => {
                ...
                prices.forEach(price => {
                    var originalPrice = parseInt(price.textContent.substring(1)); 
                    var convertedPrice = originalPrice * conversionRate;
                    price.textContent = 'BWP ' + convertedPrice.toFixed(2); 
                });
...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="shoes.jsp" class="category">Shoes & Accessories</a></li>
    ...
    %>
            ...
            <form action="logout" method="post" >
             ...
             <a class="user-logo opp" href="profileupdate.jsp"><image src="icons/user.png" class="user"/>
                  <span class="top"> <%
    try {
    ...
    <section>
        <%
            ...
            try {
                ...
                String sql = "SELECT * FROM products where category='footwear'"; 
        ...
        <%
            ...
            try {
                ...
                String sql2 = "SELECT * FROM products where category='footwear' ORDER BY price ASC"; 
        ...
        <%
            ...
            try {
                ...
                String sql3 = "SELECT * FROM products where category='footwear' ORDER BY price DESC "; 
